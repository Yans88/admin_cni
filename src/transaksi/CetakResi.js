            ...
            <div className='print-source'>
                ...
                <table className="tbl_cetak_resi">
                    ...
                    <tr>
                        ...
                        <td colSpan={4} align="center" style={{width: "50%", fontSize: 24, paddingTop: 20}}>No
                            Order: <b>MCNI/{id_transaksi}</b><br/>
                    ...
                    <tr>
                        ...
                        <td colSpan={4} valign="top">{alamat} ({kode_pos}),
                            Kec.{kec_name} {city_name} - {provinsi_name} No. Telp : {phone_penerima}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style={{
                            fontWeight: "bold",
                            paddingBottom: 20
                        }}>{type_logistic === 1 ? kode_jne_prov.substring(0, 3) : kode_lp_prov.substring(0, 3)}</td>

                    </tr>
                    {type_logistic === 2 && (
                        <tr>
                            <td colSpan="7" style={{fontSize: 15}}>Asuransi : ......................................
                            </td>
                        </tr>
                    )}
