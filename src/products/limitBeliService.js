...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.post(API_URL + "/get_lp", param)
            .then(response => {
                const data = {};
...
export const addData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/simpan_limit_beli", param)
            .then(response => {
...
export const deleteData = (param) => {
    ...
    return async (dispatch) => {
        dispatch(fetchAddDataLoading(isLoading));
        const _data = {};
        await axios.post(API_URL + "/del_lp", param)
            .then(response => {
...
export const postData = (param, action) => {
    switch (action) {
        case "VIEW_LIMIT":
            return axios.post(API_URL + "/get_lp", param)
        default:
