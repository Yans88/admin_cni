                                ...
                                <div className="col-12">
                                    ...
                                    <div className="card card-success shadow-lg" style={{"minHeight": "470px"}}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <ExcelFile filename="Report Detail" element={
                                                <AppButton
                                                    isLoading={this.props.isLoading}
                                                    type="button"
                                                    style={{marginRight: 5}}
...
const mapStateToProps = (state) => {
    return {
        data: state.reports.data_detail || [],
        data_report: state.reports.data_report_detail || [],
...
const mapDispatchToPros = (dispatch) => {
    return {
        ...
        onDownload: (queryString) => {
            dispatch(fetchExportDetail(queryString))
        }
    }
}
