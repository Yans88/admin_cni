            ...
            <>
                <React.Suspense fallback={<PageLoading/>}>
                    ...
                    <Switch basename={getBasename(window.location.pathname)}>
                        ...
                        <Route path="/cancel_customer"
                               component={user.transaksi_view ? ListTransCancelCustomer : Forbidden}/>
                        ...
                        <Route path='/blast' component={user.blast_notification_view ? BlastNotif : Forbidden}/>
                        <Route path='/add_blast' component={user.blast_notification_add ? BlastForm : Forbidden}/>
                        <Route path='/blast_detail' component={user.blast_notification_view ? BlastDetail : Forbidden}/>
                        <Route path='/report_header' component={user.report_header_view ? ReportHeader : Forbidden}/>
                        <Route path='/report_detail' component={user.report_detail_view ? ReportDetail : Forbidden}/>
                        <Route path='/report_logistik'
                               component={user.report_logistik_view ? ReportLogistik : Forbidden}/>
                        <Route path='/reg_mitra' component={user.registrasi_mitra_view ? Mitra : Forbidden}/>
                        <Route path='/waiting_simpatik' component={user.simpatik_view ? ListSimpatik : Forbidden}/>
                        <Route path='/simpatik_detail' component={user.simpatik_view ? SimpatikDetail : Forbidden}/>
                        <Route path='/diterima' component={user.simpatik_view ? ListSimpatikDiterima : Forbidden}/>
                        <Route path='/approved_simpatik'
                               component={user.simpatik_view ? ListSimpatikApproved : Forbidden}/>
                        <Route path='/rejected_simpatik'
                               component={user.simpatik_view ? ListSimpatikRejected : Forbidden}/>
                        <Route path='/completed_simpatik'
                               component={user.simpatik_view ? ListSimpatikCompleted : Forbidden}/>
