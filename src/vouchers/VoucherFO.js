...
class VoucherFO extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            title: '',
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">{this.state.isEdit ? ("Edit Voucher Free Ongkir") : "Add Voucher Free Ongkir"}</h1>
                                </div>
...
export default connect(mapStateToProps, mapDispatchToPros)(VoucherFO);