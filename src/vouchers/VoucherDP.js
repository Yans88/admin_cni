...
class VoucherDP extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            title: '',
    ...
    handleSubmit() {
        ...
        errors.satuan_potongan = !this.state.satuan_potongan ? "Satuan diskon required" : '';
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">{this.state.isEdit ? ("Edit Voucher Diskon/Potongan Harga") : "Add Voucher Diskon/Potongan Harga"}</h1>
                                </div>
                                        ...
                                        <div className="card shadow-lg">
                                            <Form id="myForm">
                                                <div className="card-body my-card-body">
                                                    ...
                                                    <Form.Row>
                                                        <Form.Group as={Col} controlId="kode_voucher">
                                                        ...
                                                        <Form.Group as={Col} xs={2} controlId="satuan_potongan">
                                                            <Form.Label>Satuan Diskon</Form.Label>

                                                            <Form.Control
                                                                value={this.state.satuan_potongan}
                                                                onChange={this.handleChange}
                                                                size="sm"
                                                                as="select"
                                                            ...
                                                            {errMsg.satuan_potongan && (<span className="text-error badge badge-danger">{errMsg.satuan_potongan}</span>)}
                                                        </Form.Group>
                                                        ...
                                                        <Form.Group as={Col} xs={2} controlId="produk_tertentu">
                                                            <Form.Label>Produk Tertentu</Form.Label>
                                                            <Row>
                                                                <Col xs={{ span: 1, offset: 2 }}>
                                                                    <Form.Check
                                                                        onChange={this.handleChange}
                                                                        checked={this.state.produk_tertentu > 0 ? ("checked") : ""}
                                                                        label={this.state.produk_tertentu > 0 ? ("Yes") : "No"}
                                                                        type="switch"
                                                                        name="produk_tertentu"
                                                                        custom
                                                                    />
                                                                </Col>
                                                            </Row>
                                                    ...
                                                    <Form.Row>
                                                        ...
                                                        <Form.Group as={Col} controlId="max_potongan">
                                                            <Form.Label>Maks. Diskon(IDR)</Form.Label>
                                                            <NumberFormat
                                                                disabled={this.state.satuan_potongan === "2" || this.state.satuan_potongan === 2 ? false : true}
                                                                name="max_potongan"
                                                                onChange={this.handleChange}
                                                                className="form-control form-control-sm"
                                                        ...
                                                        <Form.Group as={Col} xs={2} controlId="mobile">
                                                            <Form.Label style={{ marginLeft: 10 }}>Mobile</Form.Label>
                                                            <Row>
                                                                <Col xs={{ span: 1, offset: 2 }}>
                                                                    <Form.Check
                                                                        onChange={this.handleChange}
...
export default connect(mapStateToProps, mapDispatchToPros)(VoucherDP);