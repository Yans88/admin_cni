...
import { fetchData, addData, postData } from './levelService';
...
class LevelFrm extends Component {
    ...
    async handleChangeAll(evt){
        ...
        if (!this.state.selected.id_operator) await this.setState({ selected: { ...this.state.selected, id_operator: this.props.user.id_operator } });
                    ...
                    <section className="content">
                        <div className="col-12">
                            ...
                            <CardColumns>                            
                                <Card className="mb-2">
                                    <Card.Body>
                                        <Card.Title><h5 className="widget-user-desc">Coverage Area</h5></Card.Title>
                                        <div className="row card-text">
                                            <div className="col-sm-4 border-right">
                                                <div className="description-block">
