                                                ...
                                                <table className="table table-condensed">
                                                    ...
                                                    <tr>
                                                        <td style={{
                                                            ...
                                                            "fontWeight": "bold",
                                                            "fontSize": "16px"
                                                        }} colSpan="9" align="center">List Members
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <div key={i} className="col-md-4 col-sm-6 col-12">
                                                            <div className="info-box">
                                                                ...
                                                                <div className="info-box-content">
                                                                    <span
                                                                        className="info-box-text">Nama : {dt.nama}</span>
                                                                    <span
                                                                        className="info-box-text">Email : {dt.email}</span>
                                                                    <span
                                                                        className="info-box-text">Phone : {dt.phone}</span>
                                                                    <span className="info-box-number"
                                                                          style={{marginTop: 0}}>CNI ID : {dt.cni_id ? dt.cni_id : '-'}</span>
                                                                </div>
                                                                {/* /.info-box-content */}
                                                            </div>
                                                            {/* /.info-box */}
